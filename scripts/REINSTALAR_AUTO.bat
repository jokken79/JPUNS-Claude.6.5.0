...
title UNS-ClaudeJP 5.4 - Reinstalacion Completa (AUTO)

echo.
echo ============================================================================
echo                   UNS-CLAUDEJP 5.4 - REINSTALACION AUTOMATICA
...
set "ERROR_FLAG=0"
set "BACKEND_CONTAINER=uns-claudejp-600-backend-1"
...
:: ===========================================================================
::  FASE 2: CONFIRMACION (AUTOMATICA)
:: ===========================================================================

echo [FASE 2/3] Configuracion (MODO AUTOMATICO)
echo.
echo ============================================================================
echo                   CONFIGURACION AUTOMATICA
echo ============================================================================
echo  Usando credenciales por defecto:
echo    [*] Usuario: admin
...
if !errorlevel! NEQ 0 (
    ...
    echo   i Verifica los logs: docker logs %BACKEND_CONTAINER%
    pause >nul
    goto :eof
)
...
docker exec %BACKEND_CONTAINER% python -c "from passlib.context import CryptContext; pwd_context = CryptContext(schemes=['bcrypt'], deprecated='auto'); print(pwd_context.hash('!ADMIN_PASSWORD!'))" > "%TEMP%\pwd_hash.txt" 2>nul
